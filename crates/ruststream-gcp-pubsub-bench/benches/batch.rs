...
//! Consuming in batches of 64: the crate assembles the batch on the client, as Pub/Sub delivers
//! one message at a time, hands the handler a slice, and the runtime settles every delivery in it.
