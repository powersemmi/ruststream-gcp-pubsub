...
the code-cost benches under `crates/ruststream-gcp-pubsub-bench/benches`, one JSON object per
...
CODE_SCENARIOS = [
    ...
    ("reply to a declared topic, each confirmed before the next delivery", "reply/service", True),
